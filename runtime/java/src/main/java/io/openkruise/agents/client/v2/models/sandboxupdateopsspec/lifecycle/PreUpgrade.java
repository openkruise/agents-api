package io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle;

@com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"exec","timeoutSeconds"})
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(using = com.fasterxml.jackson.databind.JsonDeserializer.None.class)
public class PreUpgrade implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.preupgrade.Exec exec;

    public io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.preupgrade.Exec getExec() {
        return exec;
    }

    public void setExec(io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.preupgrade.Exec exec) {
        this.exec = exec;
    }
