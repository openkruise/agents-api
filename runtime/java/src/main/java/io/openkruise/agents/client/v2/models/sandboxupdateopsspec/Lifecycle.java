...
public class Lifecycle implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.PostUpgrade postUpgrade;

    public io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.PostUpgrade getPostUpgrade() {
        return postUpgrade;
    }

    public void setPostUpgrade(io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.PostUpgrade postUpgrade) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.PreUpgrade preUpgrade;

    public io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.PreUpgrade getPreUpgrade() {
        return preUpgrade;
    }

    public void setPreUpgrade(io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.PreUpgrade preUpgrade) {
