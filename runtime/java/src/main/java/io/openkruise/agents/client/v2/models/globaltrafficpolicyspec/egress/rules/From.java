...
public class From implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.from.Service service;

    public io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.from.Service getService() {
        return service;
    }

    public void setService(io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.from.Service service) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.from.Workload workload;

    public io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.from.Workload getWorkload() {
        return workload;
    }

    public void setWorkload(io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.from.Workload workload) {
