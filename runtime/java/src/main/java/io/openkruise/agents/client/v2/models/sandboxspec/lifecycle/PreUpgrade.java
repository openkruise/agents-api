...
public class PreUpgrade implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.sandboxspec.lifecycle.preupgrade.Exec exec;

    public io.openkruise.agents.client.v2.models.sandboxspec.lifecycle.preupgrade.Exec getExec() {
        return exec;
    }

    public void setExec(io.openkruise.agents.client.v2.models.sandboxspec.lifecycle.preupgrade.Exec exec) {
        this.exec = exec;
    }
