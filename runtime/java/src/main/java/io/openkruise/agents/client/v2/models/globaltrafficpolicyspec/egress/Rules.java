package io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress;
...
public class Rules implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.From> from;

    public java.util.List<io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.From> getFrom() {
        return from;
    }

    public void setFrom(java.util.List<io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.From> from) {
        this.from = from;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.Ports> ports;

    public java.util.List<io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.Ports> getPorts() {
        return ports;
    }

    public void setPorts(java.util.List<io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.Ports> ports) {
        this.ports = ports;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.To> to;

    public java.util.List<io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.To> getTo() {
        return to;
    }

    public void setTo(java.util.List<io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.egress.rules.To> to) {
        this.to = to;
    }
}
