...
public class PostUpgrade implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.postupgrade.Exec exec;

    public io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.postupgrade.Exec getExec() {
        return exec;
    }

    public void setExec(io.openkruise.agents.client.v2.models.sandboxupdateopsspec.lifecycle.postupgrade.Exec exec) {
        this.exec = exec;
    }
