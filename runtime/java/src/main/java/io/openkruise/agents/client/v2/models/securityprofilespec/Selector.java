...
public class Selector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.openkruise.agents.client.v2.models.securityprofilespec.selector.MatchExpressions> matchExpressions;

    public java.util.List<io.openkruise.agents.client.v2.models.securityprofilespec.selector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<io.openkruise.agents.client.v2.models.securityprofilespec.selector.MatchExpressions> matchExpressions) {
