...
public class RuntimeConfig {
     ...
     * If a custom httpClient was provided via Builder, it is used directly.
     */
     ...
     * If a custom httpClient was provided, derives a streaming variant with readTimeout=0.
     */
    public OkHttpClient getOrCreateStreamingHttpClient() {
        if (sharedStreamingClient == null) {
            synchronized (httpClientLock) {
                ...
                if (sharedStreamingClient == null) {
                    if (httpClient != null) {
                        sharedStreamingClient = httpClient.newBuilder()
    ...
    public static class Builder {
        ...
        /**
         * Sets a custom OkHttpClient for all HTTP requests.
         * When provided, this client is used directly instead of creating a default one.
         * Users can configure proxy, SSL, timeouts, interceptors, etc. on the client before passing it.
         */
