package io.openkruise.agents.client.v2.models.securityprofilespec.audit.webhook.request;
...
public class Body implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.securityprofilespec.audit.webhook.request.body.Json json;

    public io.openkruise.agents.client.v2.models.securityprofilespec.audit.webhook.request.body.Json getJson() {
        return json;
    }

    public void setJson(io.openkruise.agents.client.v2.models.securityprofilespec.audit.webhook.request.body.Json json) {
        this.json = json;
    }
