...
public class GlobalTrafficPolicySpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.Egress egress;

    public io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.Egress getEgress() {
        return egress;
    }

    public void setEgress(io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.Egress egress) {
        this.egress = egress;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.Ingress ingress;

    public io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.Ingress getIngress() {
        return ingress;
    }

    public void setIngress(io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.Ingress ingress) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.Selector selector;

    public io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.Selector getSelector() {
        return selector;
    }

    public void setSelector(io.openkruise.agents.client.v2.models.globaltrafficpolicyspec.Selector selector) {
