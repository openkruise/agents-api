package io.openkruise.agents.client.v2.models.trafficpolicyspec.egress.rules;
...
public class To implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.trafficpolicyspec.egress.rules.to.Service service;

    public io.openkruise.agents.client.v2.models.trafficpolicyspec.egress.rules.to.Service getService() {
        return service;
    }

    public void setService(io.openkruise.agents.client.v2.models.trafficpolicyspec.egress.rules.to.Service service) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.trafficpolicyspec.egress.rules.to.Workload workload;

    public io.openkruise.agents.client.v2.models.trafficpolicyspec.egress.rules.to.Workload getWorkload() {
        return workload;
    }

    public void setWorkload(io.openkruise.agents.client.v2.models.trafficpolicyspec.egress.rules.to.Workload workload) {
