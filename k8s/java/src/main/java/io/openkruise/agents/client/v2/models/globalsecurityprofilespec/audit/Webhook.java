package io.openkruise.agents.client.v2.models.globalsecurityprofilespec.audit;
...
public class Webhook implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.globalsecurityprofilespec.audit.webhook.Request request;

    public io.openkruise.agents.client.v2.models.globalsecurityprofilespec.audit.webhook.Request getRequest() {
        return request;
    }

    public void setRequest(io.openkruise.agents.client.v2.models.globalsecurityprofilespec.audit.webhook.Request request) {
