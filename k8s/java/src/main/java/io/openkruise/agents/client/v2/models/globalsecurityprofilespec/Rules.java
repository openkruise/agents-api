...
public class Rules implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.Actions actions;

    public io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.Actions getActions() {
        return actions;
    }

    public void setActions(io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.Actions actions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.Match> match;

    public java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.Match> getMatch() {
        return match;
    }

    public void setMatch(java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.Match> match) {
        this.match = match;
    }
