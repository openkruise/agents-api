...
public class Actions implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.securityprofilespec.rules.actions.HeaderManipulation headerManipulation;

    public io.openkruise.agents.client.v2.models.securityprofilespec.rules.actions.HeaderManipulation getHeaderManipulation() {
        return headerManipulation;
    }

    public void setHeaderManipulation(io.openkruise.agents.client.v2.models.securityprofilespec.rules.actions.HeaderManipulation headerManipulation) {
