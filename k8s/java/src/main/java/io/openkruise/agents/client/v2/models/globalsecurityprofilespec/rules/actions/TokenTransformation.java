...
public class TokenTransformation implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    public io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.tokentransformation.ApiKey getApiKey() {
        return apiKey;
    }

    public void setApiKey(io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.tokentransformation.ApiKey apiKey) {
        this.apiKey = apiKey;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.tokentransformation.CredentialRef credentialRef;

    public io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.tokentransformation.CredentialRef getCredentialRef() {
        return credentialRef;
    }

    public void setCredentialRef(io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.tokentransformation.CredentialRef credentialRef) {
