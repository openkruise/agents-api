...
public class PauseStrategy implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.sandboxtemplatespec.pausestrategy.HibernateStrategy hibernateStrategy;

    public io.openkruise.agents.client.v2.models.sandboxtemplatespec.pausestrategy.HibernateStrategy getHibernateStrategy() {
        return hibernateStrategy;
    }

    public void setHibernateStrategy(io.openkruise.agents.client.v2.models.sandboxtemplatespec.pausestrategy.HibernateStrategy hibernateStrategy) {
