...
public class Audit implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.globalsecurityprofilespec.audit.Webhook webhook;

    public io.openkruise.agents.client.v2.models.globalsecurityprofilespec.audit.Webhook getWebhook() {
        return webhook;
    }

    public void setWebhook(io.openkruise.agents.client.v2.models.globalsecurityprofilespec.audit.Webhook webhook) {
