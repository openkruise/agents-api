...
public class HeaderManipulation implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.headermanipulation.Set> set;

    public java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.headermanipulation.Set> getSet() {
        return set;
    }

    public void setSet(java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.headermanipulation.Set> set) {
        this.set = set;
    }
}
