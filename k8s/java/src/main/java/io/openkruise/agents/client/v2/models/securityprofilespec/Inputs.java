...
public class Inputs implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.securityprofilespec.inputs.ConfigMap configMap;

    public io.openkruise.agents.client.v2.models.securityprofilespec.inputs.ConfigMap getConfigMap() {
        return configMap;
    }

    public void setConfigMap(io.openkruise.agents.client.v2.models.securityprofilespec.inputs.ConfigMap configMap) {
