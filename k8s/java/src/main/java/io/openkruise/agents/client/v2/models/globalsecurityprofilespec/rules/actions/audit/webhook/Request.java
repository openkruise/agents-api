package io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.audit.webhook;
...
public class Request implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.audit.webhook.request.Body body;

    public io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.audit.webhook.request.Body getBody() {
        return body;
    }

    public void setBody(io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.audit.webhook.request.Body body) {
        this.body = body;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.audit.webhook.request.Headers> headers;

    public java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.audit.webhook.request.Headers> getHeaders() {
        return headers;
    }

    public void setHeaders(java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.audit.webhook.request.Headers> headers) {
