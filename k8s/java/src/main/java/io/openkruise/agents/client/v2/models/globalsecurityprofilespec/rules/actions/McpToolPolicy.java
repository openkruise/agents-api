package io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions;
...
public class McpToolPolicy implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.mcptoolpolicy.DenyResponse denyResponse;

    public io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.mcptoolpolicy.DenyResponse getDenyResponse() {
        return denyResponse;
    }

    public void setDenyResponse(io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.mcptoolpolicy.DenyResponse denyResponse) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.mcptoolpolicy.Rules> rules;

    public java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.mcptoolpolicy.Rules> getRules() {
        return rules;
    }

    public void setRules(java.util.List<io.openkruise.agents.client.v2.models.globalsecurityprofilespec.rules.actions.mcptoolpolicy.Rules> rules) {
        this.rules = rules;
    }
