...
type TrafficPolicyLister interface {
	...
	List(selector labels.Selector) (ret []*agentsv1alpha1.TrafficPolicy, err error)
...
type trafficPolicyLister struct {
	listers.ResourceIndexer[*agentsv1alpha1.TrafficPolicy]
}
...
func NewTrafficPolicyLister(indexer cache.Indexer) TrafficPolicyLister {
	return &trafficPolicyLister{listers.New[*agentsv1alpha1.TrafficPolicy](indexer, agentsv1alpha1.Resource("trafficpolicy"))}
}

// TrafficPolicies returns an object that can list and get TrafficPolicies.
func (s *trafficPolicyLister) TrafficPolicies(namespace string) TrafficPolicyNamespaceLister {
	return trafficPolicyNamespaceLister{listers.NewNamespaced[*agentsv1alpha1.TrafficPolicy](s.ResourceIndexer, namespace)}
}
...
type TrafficPolicyNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*agentsv1alpha1.TrafficPolicy, error)
