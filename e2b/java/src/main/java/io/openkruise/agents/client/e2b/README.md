...
Full
examples: [Lifecycle Management](../examples/SandboxApiManagerExample.java) | [Commands](../examples/SandboxCommandsExample.java) | [Files](../examples/SandboxFilesExample.java)
...
Full example: [SandboxCodeInterpreterExample.java](../examples/SandboxCodeInterpreterExample.java)
