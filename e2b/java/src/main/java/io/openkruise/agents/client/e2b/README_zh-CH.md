...
完整示例：[生命周期管理](../examples/SandboxApiManagerExample.java) | [命令操作](../examples/SandboxCommandsExample.java) | [文件操作](../examples/SandboxFilesExample.java)
...
完整示例：[SandboxCodeInterpreterExample.java](../examples/SandboxCodeInterpreterExample.java)
